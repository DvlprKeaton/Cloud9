...
public class AdminFragment extends Fragment {
    ...
    private void refreshInventoryItems() {
        ...
        Cursor cursor = dataAccess.getAdminAccounts();
                ...
                do {
                    ...
                    tableRow.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Cursor clickCursor = dataAccess.getAdminAccounts();
                            if (clickCursor != null && clickCursor.moveToPosition(finalCurrentRow)) {
                                // Move the cursor to the correct position before accessing the column values
                                String userID = clickCursor.getString(clickCursor.getColumnIndex(DatabaseHelper.COLUMN_USER_ID));
                                String username = clickCursor.getString(clickCursor.getColumnIndex(DatabaseHelper.COLUMN_USER_NAME));
                                String fullname = clickCursor.getString(clickCursor.getColumnIndex(DatabaseHelper.COLUMN_FUll_NAME));
                                String category = clickCursor.getString(clickCursor.getColumnIndex(DatabaseHelper.COLUMN_CATEGORY));
